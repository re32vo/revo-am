          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-xl">ستوديو<span className="text-primary">.كود</span></span>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/35">0533170903</div>
                  </div>
                </a>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex gap-3">
                {/* TikTok */}
                <a
                  href="https://tiktok.com/@studiodotcode"
                  target="_blank"
                  rel="noreferrer"
                ...
                {/* Instagram */}
                <a
                  href="https://instagram.com/studiodotcode"
                  target="_blank"
                  rel="noreferrer"
